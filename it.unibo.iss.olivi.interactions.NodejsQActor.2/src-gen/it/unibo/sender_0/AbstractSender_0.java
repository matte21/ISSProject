...
public abstract class AbstractSender_0 extends QActor implements IActivity{ 
	...
	protected IActorAction action;
		...
		protected static IOutputEnvView setTheEnv(IOutputEnvView outEnvView ){
			EnvFrame env = new EnvFrame( "Env_sender_0", java.awt.Color.cyan  , java.awt.Color.black );
			env.init();
			env.setSize(800,400);
			IOutputEnvView newOutEnvView = ((EnvFrame) env).getOutputEnvView();
			return newOutEnvView;
		}
		public AbstractSender_0(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/sender_0/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			addInputPanel(80);
			addCmdPanels();	
			this.planFilePath = "./srcMore/it/unibo/sender_0/plans.txt";
	  	}
	...
	protected void addCmdPanels(){
		...
		*/    
	    ...
	    protected void initStateTable(){  	
	    	...
	    	stateTab.put("send_msg",send_msg);
	    }
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		PlanRepeat pr = PlanRepeat.setUp("handleTout",-1);
	    		String myselfName = "handleToutBuiltIn";  
	    		println( "sender_0 tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"sender up and running\"";
	    	println( temporaryStr );  
	    	//switchTo send_msg
	        switchToPlanAsNextState(pr, myselfName, "sender_0_"+myselfName, 
	              "send_msg",false, false, null); 
	    ...
	    StateFun send_msg = () -> {	
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("send_msg",-1);
	    	String myselfName = "send_msg";  
	    	parg = "sendFromNodejs";
	    	actorOpExecute(parg, false);	//OCT17		 
	    	repeatPlanNoTransition(pr,myselfName,"sender_0_"+myselfName,false,false);
	    }catch(Exception e_send_msg){  
	    	 println( getName() + " plan=send_msg WARNING:" + e_send_msg.getMessage() );
	    	 QActorContext.terminateQActorSystem(this); 
	    }
	    };//send_msg
