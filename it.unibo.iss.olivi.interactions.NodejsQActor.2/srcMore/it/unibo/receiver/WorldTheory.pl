%==============================================
% WorldTheory.pl for actor receiver
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatureceiver).	%%old version (deprecated)
actorobj(qatureceiver).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor receiver
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of receiver" ). 
...
%-------------------------------------------------
%  User static rules about receiver
%------------------------------------------------- 
/*
------------------------------------------------------------------------
