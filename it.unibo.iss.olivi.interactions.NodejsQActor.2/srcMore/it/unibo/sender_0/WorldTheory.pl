%==============================================
% WorldTheory.pl for actor sender_0
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusender_0).	%%old version (deprecated)
actorobj(qatusender_0).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sender_0
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sender_0" ). 
...
%-------------------------------------------------
%  User static rules about sender_0
%------------------------------------------------- 
/*
------------------------------------------------------------------------
