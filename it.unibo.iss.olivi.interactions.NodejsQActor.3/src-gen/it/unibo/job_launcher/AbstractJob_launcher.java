...
public abstract class AbstractJob_launcher extends QActor implements IActivity{ 
	...
	protected IActorAction action;
		...
		protected static IOutputEnvView setTheEnv(IOutputEnvView outEnvView ){
			EnvFrame env = new EnvFrame( "Env_job_launcher", java.awt.Color.cyan  , java.awt.Color.black );
			env.init();
			env.setSize(800,400);
			IOutputEnvView newOutEnvView = ((EnvFrame) env).getOutputEnvView();
			return newOutEnvView;
		}
		public AbstractJob_launcher(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/job_launcher/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");		
			addInputPanel(80);
			addCmdPanels();	
			this.planFilePath = "./srcMore/it/unibo/job_launcher/plans.txt";
	  	}
	...
	protected void addCmdPanels(){
		...
		*/    
	    ...
	    protected void initStateTable(){  	
	    	...
	    	stateTab.put("launch_job",launch_job);
	    }
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		PlanRepeat pr = PlanRepeat.setUp("handleTout",-1);
	    		String myselfName = "handleToutBuiltIn";  
	    		println( "job_launcher tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"job_launcher up and running\"";
	    	println( temporaryStr );  
	    	//switchTo launch_job
	        switchToPlanAsNextState(pr, myselfName, "job_launcher_"+myselfName, 
	              "launch_job",false, false, null); 
	    ...
	    StateFun launch_job = () -> {	
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("launch_job",-1);
	    	String myselfName = "launch_job";  
	    	parg = "launchJob(\"./srcJS/customJob.js\")";
	    	actorOpExecute(parg, false);	//OCT17		 
	    	repeatPlanNoTransition(pr,myselfName,"job_launcher_"+myselfName,false,false);
	    }catch(Exception e_launch_job){  
	    	 println( getName() + " plan=launch_job WARNING:" + e_launch_job.getMessage() );
	    	 QActorContext.terminateQActorSystem(this); 
	    }
	    };//launch_job
