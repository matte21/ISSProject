%==============================================
% WorldTheory.pl for actor job_launcher
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatujob_launcher).	%%old version (deprecated)
actorobj(qatujob_launcher).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor job_launcher
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of job_launcher" ). 
...
%-------------------------------------------------
%  User static rules about job_launcher
%------------------------------------------------- 
/*
------------------------------------------------------------------------
